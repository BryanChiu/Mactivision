...
The Measurement framework does not have any hardware interfaces, apart from the physical machine that it is being ran on, however that machine will likely only be accessed remotely by admin users who wish to access the Measurement Framework's database.
